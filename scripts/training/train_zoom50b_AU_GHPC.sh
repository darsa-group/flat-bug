...
#SBATCH --gres=gpu:1
#SBATCH -J fb_zoom50b
#SBATCH -o /usr/home/qgg/qgeiss/flatbug-dir/logs/fb_zoom50b_%j.out
#SBATCH -e /usr/home/qgg/qgeiss/flatbug-dir/logs/fb_zoom50b_%j.err
...
CFG=$SRC/scripts/training/fb_config_zoom50b_GHPC.yaml
grep -q '^fb_zoom_min_scale: 0.15$' "$CFG" || { echo "FAIL: arm-B zoom settings not set"; exit 1; }
echo "config:"; grep -E '^fb_|^epochs' "$CFG"

NAME=fb_zoom50b_$(date +"%Y-%m-%d_%H-%M-%S")
