...
#SBATCH -t 48:00:00
#SBATCH --gres=gpu:1
#SBATCH -J fb_axbcontain
#SBATCH -o /usr/home/qgg/qgeiss/flatbug-dir/logs/fb_axbcontain_%j.out
#SBATCH -e /usr/home/qgg/qgeiss/flatbug-dir/logs/fb_axbcontain_%j.err
...
NAME=fb_axbcontain50_$(date +"%Y-%m-%d_%H-%M-%S")
