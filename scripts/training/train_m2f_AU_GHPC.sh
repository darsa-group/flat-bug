...
# Mask2Former counterpart of train_AU_GHPC.sh.
#
# Consumes the *same* prepared dataset as the YOLO training - fb_prepare_data
# output is shared - so by default this skips the clone/prepare step and trains
# on whatever is already in ${ROOT}/flat-bug-data/yolo/.
#
