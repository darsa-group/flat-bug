...
if __name__ == "__main__":
    ...
    experiment_runner = ExperimentRunner(inputs=experiment_configs, devices=args.devices, dry_run=args.dry_run, slurm=args.slurm, slurm_params=read_slurm_params(args.partition, **extra))
